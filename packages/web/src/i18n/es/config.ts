...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Marea despreciable, menos de 0,5 kn (medida con Copernicus Báltico, no servida): la app usa allí la corriente global, que también lleva las corrientes de viento",
  ...
  "config.methodo.tidal.status.negligible": "marea despreciable (menos de 0,5 kn según Copernicus Báltico): la corriente mostrada viene del modelo global",
