...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.status.coveredBand": "covered, maximum tidal current {band}",
  "config.methodo.tidal.band.between": "{a} to {b} kt",
  "config.methodo.tidal.band.over": "{kt} kt and above",
