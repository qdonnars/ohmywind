...
export const plan: Record<keyof typeof frPlan, string> = {
  ...
  "plan.notice.currents.tidal_gap": "Corrientes de marea probablemente fuertes ({zones}) y no resueltas por nuestras fuentes: las corrientes indicadas provienen de un modelo global a 8 km que no las ve. Trabajamos para ampliar la cobertura, pero no todos los datos son de libre acceso.",
