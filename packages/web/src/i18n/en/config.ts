...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Negligible tide, under 0.5 kt (measured by Copernicus Baltic, not served): the app uses the global current there, which also carries the wind-driven flow",
  ...
  "config.methodo.tidal.status.negligible": "negligible tide (under 0.5 kt per Copernicus Baltic): the current shown comes from the global model",
