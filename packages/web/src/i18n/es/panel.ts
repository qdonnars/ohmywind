...
export const panel: Record<keyof typeof frPanel, string> = {
  ...
  "panel.route.title": "Su ruta",
  "panel.route.points.one": "{count} punto colocado",
  "panel.route.points.other": "{count} puntos colocados",
  "panel.route.summary": "{points} puntos · {legs} · {nm} nm",
  ...
  "panel.compare.row.fromPlan": "actual",
  ...
  "panel.window.to": "Al",
  "panel.window.fromHint": "salida del plan",
  ...
  "panel.window.fromAria": "Inicio de la ventana de salida",
  "panel.window.toAria": "Fin de la ventana de salida",
  ...
  "panel.tracks.departure.aria": "Salida común a los trazados",
