...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.popup.passedOver": "Hier ebenfalls verfügbar, nicht gewählt (Rang, dann Auflösung)",
  "config.methodo.tidal.popup.ignoredAtlas": "{label}, Gitter {size}, Rang {rank}",
  "config.methodo.tidal.popup.shomZone": "SHOM Atlas C2D, Zone {zone} (genutzt im Umkreis von 500 m eines Messpunkts)",
