...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.docs.tidalCurrents": "Correnti di marea",
  ...
  "config.methodo.tidal.fullscreen.enter": "Mostra la mappa a schermo intero",
  "config.methodo.tidal.fullscreen.exit": "Esci dallo schermo intero",
  "config.methodo.tidal.fullscreen.ramp": "da 0,5 a 5 kn e oltre",
  "config.methodo.tidal.legend.title": "Corrente di marea calcolata dagli atlanti (da 0,5 kn)",
  "config.methodo.tidal.legend.covered": "Coperto: corrente di marea massima, chiaro a 0,5 kn e scuro da 5 kn in su",
  "config.methodo.tidal.legend.calm": "Coperto, corrente di marea debole (meno di 0,5 kn)",
  "config.methodo.tidal.legend.target": "Oltre 1,5 kn non coperto, fonte aperta identificata",
  "config.methodo.tidal.legend.blocked": "Oltre 1,5 kn non coperto, dati esistenti ma chiusi o da chiarire",
  "config.methodo.tidal.legend.unknown": "Oltre 1,5 kn non coperto, nessuna fonte nota",
  ...
  "config.methodo.tidal.note": "Altrove l'app usa il modello globale Open-Meteo SMOC a 8 km. Il calcolo « dove c'è corrente » viene dall'atlante più fine disponibile in ogni punto (MARC 250-700 m, BSH 90-926 m, Copernicus 1,5-4 km, ATLNE 2 km, FES2014 7 km): un passaggio più stretto della maglia non vi compare, i passaggi noti completano.",
  ...
  "config.methodo.tidal.popup.passedOver": "Disponibili anche qui, scartate",
  "config.methodo.tidal.reason.noShomPoint": "nessun punto rilevato entro 500 m",
  "config.methodo.tidal.reason.afterShom": "SHOM prima",
  "config.methodo.tidal.reason.lowerRank": "rango inferiore",
  "config.methodo.tidal.reason.coarser": "maglia più grossolana",
  "config.methodo.tidal.reason.tie": "stesso rango, secondo",
  "config.methodo.tidal.reason.fallback": "ultimo ripiego",
  "config.methodo.tidal.reason.noCell": "nessuna cella qui",
  "config.methodo.tidal.popup.smoc": "Open-Meteo SMOC, modello globale a 8 km",
  "config.methodo.tidal.popup.land": "Punto a terra: nessuna corrente di marea, nulla viene restituito",
  ...
  "config.methodo.tidal.status.coveredValue": "coperta, corrente di marea massima {kt} kn ({atlas})",
  "config.methodo.tidal.status.calmValue": "coperta, marea debole: {kt} kn al massimo ({atlas})",
  "config.methodo.tidal.status.calm": "coperta, corrente di marea debole",
  ...
  "config.methodo.tidal.popup.fallback": "Ripiego mondiale",
  "config.methodo.tidal.popup.fallbackNote": "non conta come copertura",
  ...
  "config.methodo.tidal.sources.access": "Accesso e aggiornamento",
  "config.methodo.tidal.sources.accessHow": "Accesso",
  "config.methodo.tidal.sources.updateHow": "Aggiornamento",
