...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.current": "1. Dónde hay corriente",
  "config.methodo.tidal.layer.mask05": "Más de 0,5 kn (calculado, Atlántico nororiental)",
  "config.methodo.tidal.layer.mask15": "Más de 1,5 kn (calculado, Atlántico nororiental)",
  "config.methodo.tidal.layer.passes": "Pasos y rasas conocidos, tamaño según la corriente",
  "config.methodo.tidal.legend.coverage": "2. Lo que usa la aplicación",
  "config.methodo.tidal.layer.shom": "Puntos SHOM (fino, a menos de 500 m de un punto)",
  "config.methodo.tidal.layer.fine": "Fino: 500 m o mejor, resuelve un paso",
  "config.methodo.tidal.layer.medium": "Medio: hasta 1 km, resuelve un estuario",
  "config.methodo.tidal.layer.coarse": "Grueso: 2 km, solo dice «aquí hay marea»",
  "config.methodo.tidal.layer.spike": "En preparación (BSH, aún no en servicio)",
  "config.methodo.tidal.legend.gaps": "3. Lo que falta en la zona objetivo",
  "config.methodo.tidal.layer.objective": "Zona objetivo (Europa)",
  "config.methodo.tidal.layer.gapMask": "Más de 1,5 kn sin fuente fina ni media",
  "config.methodo.tidal.layer.gapPasses": "Paso conocido sin fuente fina ni media",
  "config.methodo.tidal.layer.sources": "Fuentes candidatas (registro, licencia leída y fechada)",
  "config.methodo.tidal.note": "En el resto, la aplicación usa el modelo global Open-Meteo SMOC a 8 km. La capa «dónde hay corriente» se calcula del atlas ATLNE a 2 km y no ve un paso más estrecho que su celda: los pasos conocidos completan.",
  "config.methodo.tidal.popup.title": "Aquí, la aplicación usa",
  "config.methodo.tidal.popup.loading": "Consultando el servidor…",
  "config.methodo.tidal.popup.error": "Servidor inaccesible: sin respuesta para este punto.",
  "config.methodo.tidal.popup.source": "Fuente",
  "config.methodo.tidal.popup.smoc": "Open-Meteo SMOC, modelo global a 8 km",
  "config.methodo.tidal.popup.atlas": "Atlas armónico, malla de {size}",
  "config.methodo.tidal.popup.shom": "SHOM Atlas C2D, punto tomado a {distance} m",
  ...
  "config.methodo.tidal.precision.coarse": "gruesa (2 km)",
  "config.methodo.tidal.precision.global": "global (8 km)",
  "config.methodo.tidal.popup.current": "Corriente de marea máxima aquí",
  "config.methodo.tidal.current.over15": "más de 1,5 kn",
  "config.methodo.tidal.current.over05": "entre 0,5 y 1,5 kn",
  "config.methodo.tidal.current.under05": "menos de 0,5 kn",
  "config.methodo.tidal.current.unknown": "fuera del cálculo",
  ...
  "config.methodo.tidal.pass.published": "Corriente de sicigia publicada",
