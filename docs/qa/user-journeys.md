...
- Attendu: en Moyenne, la carte affiche « moyenne de N pas », les fourchettes (vent, mer, courant) et un halo autour de la flèche de vent quand les pas ne sont pas d'accord sur la direction. En Détail, l'en-tête donne l'heure du pas et son rang (« 2/3 »), les valeurs sont celles du pas, et un point de la couleur du pas apparaît sur le tronçon surligné de la carte. Un tronçon court (un seul pas) n'a ni bouton ni flèches actives. Bouton retour Android: replie le tronçon.
