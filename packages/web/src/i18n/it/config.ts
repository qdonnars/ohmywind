...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.hint": "Cliccate sul mare: la scheda indica la fonte che l'app usa in quel punto, così come la sceglie il server.",
  "config.methodo.tidal.legend.current": "1. Dove c'è corrente",
  "config.methodo.tidal.layer.mask05": "Oltre 0,5 kn (calcolato, Atlantico nord-orientale)",
  "config.methodo.tidal.layer.mask15": "Oltre 1,5 kn (calcolato, Atlantico nord-orientale)",
  "config.methodo.tidal.layer.passes": "Passaggi e correnti note, dimensione secondo la corrente",
  "config.methodo.tidal.legend.coverage": "2. Cosa usa l'app",
  "config.methodo.tidal.layer.shom": "Punti SHOM (fine, a meno di 500 m da un punto)",
  "config.methodo.tidal.layer.fine": "Fine: 500 m o meglio, risolve un passaggio",
  "config.methodo.tidal.layer.medium": "Media: fino a 1 km, risolve un estuario",
  "config.methodo.tidal.layer.coarse": "Grossolana: 2 km, dice solo «qui c'è marea»",
  "config.methodo.tidal.layer.spike": "In preparazione (BSH, non ancora in servizio)",
  "config.methodo.tidal.legend.gaps": "3. Cosa manca nella zona obiettivo",
  "config.methodo.tidal.layer.objective": "Zona obiettivo (Europa)",
  "config.methodo.tidal.layer.gapMask": "Oltre 1,5 kn senza fonte fine o media",
  "config.methodo.tidal.layer.gapPasses": "Passaggio noto senza fonte fine o media",
  "config.methodo.tidal.layer.sources": "Fonti candidate (registro, licenza letta e datata)",
  "config.methodo.tidal.note": "Altrove l'app usa il modello globale Open-Meteo SMOC a 8 km. Il livello «dove c'è corrente» è calcolato dall'atlante ATLNE a 2 km e non vede un passaggio più stretto della sua cella: i passaggi noti completano.",
  "config.methodo.tidal.popup.title": "Qui l'app usa",
  "config.methodo.tidal.popup.loading": "Interrogazione del server…",
  "config.methodo.tidal.popup.error": "Server non raggiungibile: nessuna risposta per questo punto.",
  ...
  "config.methodo.tidal.precision.coarse": "grossolana (2 km)",
  "config.methodo.tidal.precision.global": "globale (8 km)",
  ...
  "config.methodo.tidal.popup.none": "nessuna individuata",
