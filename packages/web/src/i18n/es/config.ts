...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.status.coveredBand": "cubierta, corriente de marea máxima {band}",
  "config.methodo.tidal.band.between": "de {a} a {b} kn",
  "config.methodo.tidal.band.over": "{kt} kn o más",
