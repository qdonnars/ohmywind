...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.status.coveredBand": "abgedeckt, maximaler Gezeitenstrom {band}",
  "config.methodo.tidal.band.between": "{a} bis {b} kn",
  "config.methodo.tidal.band.over": "ab {kt} kn",
