...
- Étapes: ouvrir /config, sélecteur « Langue » au-dessus des onglets, choisir English, puis Deutsch, Italiano et Español. Revenir sur / puis /plan, lancer un calcul. Ouvrir /methodologie et /confidentialite. Recharger. Effacer la clé `ow_lang` du localStorage et recharger avec un navigateur en fr-FR, puis en es-ES.
