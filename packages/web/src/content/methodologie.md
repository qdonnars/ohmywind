...
**Ce qui est couvert, ce qui manque.** La carte ci-dessous répond à trois questions : où le courant de marée compte (zones à plus de 0,5 et 1,5 kt calculées depuis l'atlas ATLNE, complétées par les passes et raz connus), ce que l'application utilise aujourd'hui et à quelle précision, et ce qui manque dans la zone objectif (Europe) : les endroits à fort courant sans source fine ni moyenne. Un clic sur la mer interroge le serveur et affiche la source qu'il choisirait à cet endroit. Les sources candidates et leur licence sont dans le registre, replié par défaut : toutes ne sont pas en libre accès, et c'est ce qui rythme l'extension de la couverture.
