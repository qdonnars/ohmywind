...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.fullscreen.ramp": "de 0 a 5 kn o más",
  "config.methodo.tidal.legend.title": "Corriente de marea calculada desde los atlas (0,5 kn o más)",
  "config.methodo.tidal.legend.covered": "Cubierto: corriente de marea máxima, del verde más claro a 0 kn al más oscuro a partir de 5 kn",
  ...
  "config.methodo.tidal.legend.negligible": "Mismo verde claro: cubierto, marea no significativa (un modelo de marea encuentra allí menos de 0,2 kn, 0,5 kn en el Báltico); la corriente mostrada viene del modelo global, que también lleva las corrientes de viento",
  ...
  "config.methodo.tidal.status.negligible": "cubierto, marea no significativa: el modelo de marea encuentra aquí menos de 0,2 kn (0,5 kn en el Báltico); la corriente mostrada viene del modelo global",
  ...
  "config.methodo.tidal.sources.grid": "Malla",
  ...
  "config.methodo.tidal.sources.accessKind": "Acceso y licencia",
  "config.methodo.tidal.sources.automation": "Automatizable",
  "config.methodo.tidal.sources.cadence": "Actualización",
  "config.methodo.tidal.sources.freshness": "Estado de los datos",
  "config.methodo.tidal.sources.how": "Cómo",
  "config.methodo.tidal.access.keyless": "sin clave",
  "config.methodo.tidal.access.free_account": "cuenta gratuita",
  "config.methodo.tidal.access.api_key": "clave API gratuita",
  "config.methodo.tidal.access.sftp_account": "SFTP con cuenta",
  "config.methodo.tidal.access.on_request": "bajo petición",
  "config.methodo.tidal.access.paid": "de pago",
  "config.methodo.tidal.access.none": "sin acceso abierto",
  "config.methodo.tidal.licenceClass.open": "abierta",
  "config.methodo.tidal.licenceClass.non_commercial": "no comercial",
  "config.methodo.tidal.licenceClass.paid": "de pago",
  "config.methodo.tidal.licenceClass.other": "otra, por aclarar",
  "config.methodo.tidal.automation.auto": "sí",
  "config.methodo.tidal.automation.auto_secret": "sí, con un secreto",
  "config.methodo.tidal.automation.manual": "manual",
  "config.methodo.tidal.automation.none": "no",
  "config.methodo.tidal.cadence.live": "en cada petición",
  "config.methodo.tidal.cadence.daily": "cada día",
  "config.methodo.tidal.cadence.weekly": "cada semana",
  "config.methodo.tidal.cadence.monthly": "cada mes",
  "config.methodo.tidal.cadence.yearly": "cada año",
  "config.methodo.tidal.cadence.decade": "cada 10 años",
  "config.methodo.tidal.cadence.frozen": "congelada",
  "config.methodo.tidal.cadence.none": "no prevista",
  "config.methodo.tidal.freshness.live": "en directo",
  "config.methodo.tidal.freshness.fresh": "al día",
  "config.methodo.tidal.freshness.late": "con retraso",
  "config.methodo.tidal.freshness.frozen": "edición congelada",
  "config.methodo.tidal.freshness.undated": "sin fecha",
  "config.methodo.tidal.freshness.unserved": "no servidos",
  "config.methodo.tidal.freshness.note": "«Al día»: nuestra copia se reconstruyó dentro del plazo que marca su frecuencia de actualización (fecha del final del periodo analizado). «Con retraso»: la última actualización prevista no se hizo. Un atlas de marea con retraso se sigue sirviendo: sus constantes armónicas siguen siendo válidas durante años, la señal sirve para detectar una cadena de actualización detenida.",
