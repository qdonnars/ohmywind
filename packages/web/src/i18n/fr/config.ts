...
export const config = {
  ...
  "config.methodo.tidal.legend.current": "1. Où il y a du courant",
  "config.methodo.tidal.layer.mask05": "Plus de 0,5 kt (calculé, Atlantique nord-est)",
  "config.methodo.tidal.layer.mask15": "Plus de 1,5 kt (calculé, Atlantique nord-est)",
  "config.methodo.tidal.layer.passes": "Passes et raz connus, taille selon le courant",
  "config.methodo.tidal.legend.coverage": "2. Ce que l'application utilise",
  "config.methodo.tidal.layer.shom": "Points SHOM (fin, à moins de 500 m d'un point)",
  "config.methodo.tidal.layer.fine": "Fin : 500 m ou mieux, résout une passe",
  "config.methodo.tidal.layer.medium": "Moyen : jusqu'à 1 km, résout un estuaire",
  "config.methodo.tidal.layer.coarse": "Grossier : 2 km, dit seulement « il y a de la marée »",
  "config.methodo.tidal.layer.spike": "En préparation (BSH, pas encore servi)",
  "config.methodo.tidal.legend.gaps": "3. Ce qui manque dans la zone objectif",
  "config.methodo.tidal.layer.objective": "Zone objectif (Europe)",
  "config.methodo.tidal.layer.gapMask": "Plus de 1,5 kt sans source fine ni moyenne",
  "config.methodo.tidal.layer.gapPasses": "Passe connue sans source fine ni moyenne",
  "config.methodo.tidal.layer.sources": "Sources candidates (registre, licence lue et datée)",
  "config.methodo.tidal.note": "Ailleurs, l'application utilise le modèle global Open-Meteo SMOC à 8 km. Le calcul « où il y a du courant » vient de l'atlas ATLNE à 2 km et ne voit pas une passe plus étroite que sa maille : les passes connues complètent.",
  ...
  "config.methodo.tidal.precision.coarse": "grossière (2 km)",
  "config.methodo.tidal.precision.global": "mondiale (8 km)",
  "config.methodo.tidal.popup.current": "Courant tidal maximal ici",
  "config.methodo.tidal.current.over15": "plus de 1,5 kt",
  "config.methodo.tidal.current.over05": "entre 0,5 et 1,5 kt",
  "config.methodo.tidal.current.under05": "moins de 0,5 kt",
  "config.methodo.tidal.current.unknown": "hors du calcul",
