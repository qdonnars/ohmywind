...
export const plan: Record<keyof typeof frPlan, string> = {
  ...
  "plan.notice.currents.pass_unresolved": "Paso no resuelto por el atlas de corrientes ({zones}): su malla lee allí como mucho una fracción de la corriente de sicigia publicada, las corrientes indicadas están subestimadas. Consulte las tablas o el atlas de corrientes local.",
