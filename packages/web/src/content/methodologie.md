...
- [Les sources de données](#les-sources-de-données)
  ...
  - [Courants de marée : sources, priorité et couverture](#courants-de-marée--sources-priorité-et-couverture)
...
### Courants de marée : sources, priorité et couverture
...
**Ce qui est couvert, ce qui manque.** La carte ci-dessous ne montre que les zones où le courant de marée dépasse 1,5 kt (calculées depuis les atlas ATLNE à 2 km et FES2014 à 7 km, complétées par les passes et raz connus), en quatre couleurs : vert quand une source de marée à 5 km ou plus fin les couvre, orange quand elles ne sont pas couvertes mais qu'une source en licence ouverte est identifiée, violet quand les données existent mais sont fermées ou à clarifier, rouge quand aucune source n'est connue. Une passe compte comme couverte à 1 km ou plus fin. Un clic sur la mer interroge le serveur et affiche la source qu'il choisirait à cet endroit. Le registre des sources, replié sous la carte, donne le producteur et la licence lue et datée de chacune, permet d'afficher son emprise, et se termine par une adresse pour en proposer une : toutes ne sont pas en libre accès, et c'est ce qui rythme l'extension de la couverture.
