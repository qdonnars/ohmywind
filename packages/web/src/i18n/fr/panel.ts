...
export const panel = {
  ...
  "panel.compare.tracksEmpty": "Aucune variante pour l'instant. Tracez-en une pour la comparer à l'itinéraire du plan.",
  ...
  "panel.tracks.planSub": "itinéraire du plan",
  "panel.tracks.drawnAt": "variante tracée à {time}",
  "panel.tracks.max": "Trois options au plus.",
  "panel.tracks.drawing.title": "Option {n} · itinéraire en cours",
  ...
  "panel.tracks.row.open": "Ouvrir cet itinéraire dans le plan",
  "panel.tracks.row.sea": "mer {avg} m (max {max})",
  "panel.tracks.row.computing": "calcul en cours…",
  "panel.tracks.stale": "Départ ou bateau modifié. Recalculez pour comparer les itinéraires.",
  "panel.tracks.departure.title": "Départ, commun à tous les itinéraires",
  "panel.tracks.departure.note": "Changer ce départ recalcule tous les itinéraires. Pour tester plusieurs heures sur un seul itinéraire, revenez au plan et choisissez « D'autres départs ».",
  "panel.tracks.departure.recompute.one": "Recalcul de {count} itinéraire",
  "panel.tracks.departure.recompute.other": "Recalcul de {count} itinéraires",

  // ── two doors, track selection, folded alerts ──
  "panel.door.slots": "D'autres départs",
  "panel.door.tracks": "Un autre itinéraire",
