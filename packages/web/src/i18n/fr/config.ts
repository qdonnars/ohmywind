...
export const config = {
  ...
  "config.methodo.tidal.popup.passedOver": "Aussi disponibles ici, écartées (rang, puis résolution)",
  "config.methodo.tidal.popup.ignoredAtlas": "{label}, maille {size}, rang {rank}",
  "config.methodo.tidal.popup.shomZone": "SHOM Atlas C2D, zone {zone} (retenu à moins de 500 m d'un point relevé)",
