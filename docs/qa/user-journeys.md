...
- Attendu: en Moyenne, la carte affiche « moyenne de N pas », les fourchettes (vent, mer, courant) et un halo autour de la flèche de vent quand les pas ne sont pas d'accord sur la direction. En Détail, l'en-tête donne l'heure du pas et son rang (« 2/3 »), les valeurs sont celles du pas, et le segment du pas s'affiche par-dessus le tronçon surligné de la carte, dans la couleur de son bloc, avec un liseré blanc. Un tronçon court (un seul pas) n'a ni bande, ni bouton, ni flèches : la carte montre directement le pas, sous ses heures. Bouton retour Android: replie le tronçon.
