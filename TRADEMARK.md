...
- forker, modifier et redistribuer le code sous un autre nom
- mentionner qu'un projet est « basé sur OhMyWind »
- citer le nom pour désigner ce projet, dans un article, un tutoriel ou une
  comparaison

## Vous ne pouvez pas, sans autorisation écrite

- publier un fork sous le nom « OhMyWind » ou un nom similaire
- utiliser le nom d'une manière suggérant une affiliation officielle
- reprendre l'identité visuelle du projet dans la vôtre
...
- fork, modify and redistribute the code under a different name
- state that a project is "based on OhMyWind"
- use the name to refer to this project, in an article, a tutorial or a
  comparison

## You may not, without written permission

- publish a fork under the name "OhMyWind" or a confusingly similar name
- use the name in a way that suggests an official affiliation
- reuse the project's visual identity as your own
