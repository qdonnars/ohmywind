...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Cubierto, marea no significativa: un modelo de marea cubre estas aguas y encuentra menos de 0,2 kn (0,5 kn en el Báltico); la corriente mostrada viene del modelo global, que también lleva las corrientes de viento",
