...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.hint": "Klicken Sie auf das Meer: die Karte nennt die Quelle, die die App an dieser Stelle verwendet, so wie der Server sie wählt.",
  "config.methodo.tidal.legend.current": "1. Wo Strom herrscht",
  "config.methodo.tidal.layer.mask05": "Über 0,5 kn (berechnet, Nordostatlantik)",
  "config.methodo.tidal.layer.mask15": "Über 1,5 kn (berechnet, Nordostatlantik)",
  "config.methodo.tidal.layer.passes": "Bekannte Engstellen und Stromkabbelungen, Größe nach Strom",
  "config.methodo.tidal.legend.coverage": "2. Was die App verwendet",
  "config.methodo.tidal.layer.shom": "SHOM-Punkte (fein, näher als 500 m an einem Punkt)",
  "config.methodo.tidal.layer.fine": "Fein: 500 m oder besser, löst eine Engstelle auf",
  "config.methodo.tidal.layer.medium": "Mittel: bis 1 km, löst eine Flussmündung auf",
  "config.methodo.tidal.layer.coarse": "Grob: 2 km, sagt nur „hier gibt es Gezeiten“",
  "config.methodo.tidal.layer.spike": "In Vorbereitung (BSH, noch nicht im Einsatz)",
  "config.methodo.tidal.legend.gaps": "3. Was im Zielgebiet fehlt",
  "config.methodo.tidal.layer.objective": "Zielgebiet (Europa)",
  "config.methodo.tidal.layer.gapMask": "Über 1,5 kn ohne feine oder mittlere Quelle",
  "config.methodo.tidal.layer.gapPasses": "Bekannte Engstelle ohne feine oder mittlere Quelle",
  "config.methodo.tidal.layer.sources": "Kandidatenquellen (Register, Lizenz gelesen und datiert)",
  "config.methodo.tidal.note": "Anderswo verwendet die App das globale Modell Open-Meteo SMOC mit 8 km. Die Ebene „wo Strom herrscht“ ist aus dem 2-km-Atlas ATLNE berechnet und sieht keine Engstelle, die schmaler als seine Zelle ist: die bekannten Engstellen ergänzen sie.",
  "config.methodo.tidal.popup.title": "Hier verwendet die App",
  ...
  "config.methodo.tidal.popup.shom": "SHOM Atlas C2D, Punkt in {distance} m Entfernung",
  ...
  "config.methodo.tidal.precision.coarse": "grob (2 km)",
  ...
  "config.methodo.tidal.popup.pass": "Bekannte Engstelle im Umkreis von 25 km",
  ...
  "config.methodo.tidal.source.status.ok": "Lizenz kompatibel",
