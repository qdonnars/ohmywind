...
export const config = {
  ...
  "config.methodo.tidal.status.coveredBand": "couverte, courant de marée maximal {band}",
  "config.methodo.tidal.band.between": "de {a} à {b} kt",
  "config.methodo.tidal.band.over": "{kt} kt et plus",
