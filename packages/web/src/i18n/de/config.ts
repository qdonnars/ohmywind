...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.fullscreen.ramp": "0 bis 5 kn und mehr",
  "config.methodo.tidal.legend.title": "Aus den Atlanten berechneter Gezeitenstrom (ab 0,5 kn)",
  "config.methodo.tidal.legend.covered": "Abgedeckt: maximaler Gezeitenstrom, vom hellsten Grün bei 0 kn bis zum dunkelsten ab 5 kn",
  "config.methodo.tidal.legend.calm": "Abgedeckt, schwacher Gezeitenstrom (unter 0,5 kn)",
  "config.methodo.tidal.legend.target": "Über 1,5 kn nicht abgedeckt, offene Quelle identifiziert",
  "config.methodo.tidal.legend.blocked": "Über 1,5 kn nicht abgedeckt, Daten vorhanden, aber geschlossen oder unklar",
  "config.methodo.tidal.legend.unknown": "Über 1,5 kn nicht abgedeckt, keine bekannte Quelle",
  ...
  "config.methodo.tidal.legend.negligible": "Gleiches helles Grün: abgedeckt, Gezeiten nicht maßgeblich (ein Gezeitenmodell findet dort unter 0,2 kn, 0,5 kn in der Ostsee); die angezeigte Strömung stammt dort aus dem globalen Modell, das auch die windgetriebene Strömung enthält",
  "config.methodo.tidal.legend.objective": "Zielgebiet",
  "config.methodo.tidal.note": "Anderswo nutzt die App das globale Open-Meteo-Modell SMOC mit 8 km. Die Berechnung „wo es Strom gibt“ stammt aus dem jeweils feinsten verfügbaren Atlas (MARC 250 bis 700 m, BSH 90 bis 926 m, Copernicus 1,5 bis 4 km, ATLNE 2 km, FES2014 7 km): eine Passage, die schmaler als das Gitter ist, erscheint dort nicht, die bekannten Passagen ergänzen sie.",
  ...
  "config.methodo.tidal.popup.passedOver": "Hier ebenfalls verfügbar, nicht gewählt",
  "config.methodo.tidal.reason.noShomPoint": "kein Messpunkt im Umkreis von 500 m",
  "config.methodo.tidal.reason.afterShom": "SHOM zuerst",
  "config.methodo.tidal.reason.lowerRank": "niedrigerer Rang",
  "config.methodo.tidal.reason.coarser": "gröberes Gitter",
  "config.methodo.tidal.reason.tie": "gleicher Rang, zweiter",
  "config.methodo.tidal.reason.fallback": "letzter Rückfall",
  "config.methodo.tidal.reason.noCell": "keine Zelle hier",
  "config.methodo.tidal.popup.smoc": "Open-Meteo SMOC, globales Modell mit 8 km",
  "config.methodo.tidal.popup.land": "Punkt an Land: kein Gezeitenstrom, nichts wird zurückgegeben",
  ...
  "config.methodo.tidal.status.coveredValue": "abgedeckt, maximaler Gezeitenstrom {kt} kn ({atlas})",
  "config.methodo.tidal.status.calmValue": "abgedeckt, schwache Tide: höchstens {kt} kn ({atlas})",
  "config.methodo.tidal.status.negligible": "abgedeckt, Gezeiten nicht maßgeblich: Das Gezeitenmodell findet hier unter 0,2 kn (0,5 kn in der Ostsee); die angezeigte Strömung stammt aus dem globalen Modell",
  "config.methodo.tidal.status.calm": "abgedeckt, schwacher Gezeitenstrom",
  ...
  "config.methodo.tidal.sources.grid": "Gitter",
  ...
  "config.methodo.tidal.sources.accessKind": "Zugang und Lizenz",
  "config.methodo.tidal.sources.automation": "Automatisierbar",
  "config.methodo.tidal.sources.cadence": "Aktualisierung",
  "config.methodo.tidal.sources.freshness": "Datenstand",
  "config.methodo.tidal.sources.how": "Wie",
  "config.methodo.tidal.access.keyless": "ohne Schlüssel",
  "config.methodo.tidal.access.free_account": "kostenloses Konto",
  "config.methodo.tidal.access.api_key": "kostenloser API-Schlüssel",
  "config.methodo.tidal.access.sftp_account": "SFTP mit Konto",
  "config.methodo.tidal.access.on_request": "auf Anfrage",
  "config.methodo.tidal.access.paid": "kostenpflichtig",
  "config.methodo.tidal.access.none": "kein offener Zugang",
  "config.methodo.tidal.licenceClass.open": "offen",
  "config.methodo.tidal.licenceClass.non_commercial": "nicht kommerziell",
  "config.methodo.tidal.licenceClass.paid": "kostenpflichtig",
  "config.methodo.tidal.licenceClass.other": "sonstige, unklar",
  "config.methodo.tidal.automation.auto": "ja",
  "config.methodo.tidal.automation.auto_secret": "ja, mit Geheimnis",
  "config.methodo.tidal.automation.manual": "manuell",
  "config.methodo.tidal.automation.none": "nein",
  "config.methodo.tidal.cadence.live": "bei jeder Anfrage",
  "config.methodo.tidal.cadence.daily": "täglich",
  "config.methodo.tidal.cadence.weekly": "wöchentlich",
  "config.methodo.tidal.cadence.monthly": "monatlich",
  "config.methodo.tidal.cadence.yearly": "jährlich",
  "config.methodo.tidal.cadence.decade": "alle 10 Jahre",
  "config.methodo.tidal.cadence.frozen": "eingefroren",
  "config.methodo.tidal.cadence.none": "nicht geplant",
  "config.methodo.tidal.freshness.live": "live",
  "config.methodo.tidal.freshness.fresh": "aktuell",
  "config.methodo.tidal.freshness.late": "verspätet",
  "config.methodo.tidal.freshness.frozen": "feste Ausgabe",
  "config.methodo.tidal.freshness.undated": "ohne Datum",
  "config.methodo.tidal.freshness.unserved": "nicht bereitgestellt",
  "config.methodo.tidal.freshness.note": "„Aktuell“: Unsere Kopie wurde innerhalb der Frist ihrer Aktualisierungshäufigkeit neu erstellt (Datum des Endes des analysierten Zeitraums). „Verspätet“: Die letzte geplante Aktualisierung hat nicht stattgefunden. Ein verspäteter Gezeitenatlas wird weiter bereitgestellt: Seine harmonischen Konstanten bleiben jahrelang gültig, die Markierung zeigt eine angehaltene Aktualisierungskette an.",
