...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.fullscreen.ramp": "da 0 a 5 kn e oltre",
  "config.methodo.tidal.legend.title": "Corrente di marea calcolata dagli atlanti (da 0,5 kn)",
  "config.methodo.tidal.legend.covered": "Coperto: corrente di marea massima, dal verde più chiaro a 0 kn al più scuro da 5 kn in su",
  ...
  "config.methodo.tidal.legend.negligible": "Stesso verde chiaro: coperto, marea non significativa (un modello di marea vi trova meno di 0,2 kn, 0,5 kn nel Baltico); la corrente mostrata viene dal modello globale, che porta anche le correnti da vento",
  ...
  "config.methodo.tidal.status.negligible": "coperto, marea non significativa: il modello di marea vi trova meno di 0,2 kn (0,5 kn nel Baltico); la corrente mostrata viene dal modello globale",
  ...
  "config.methodo.tidal.sources.grid": "Maglia",
  ...
  "config.methodo.tidal.sources.accessKind": "Accesso e licenza",
  "config.methodo.tidal.sources.automation": "Automatizzabile",
  "config.methodo.tidal.sources.cadence": "Aggiornamento",
  "config.methodo.tidal.sources.freshness": "Stato dei dati",
  "config.methodo.tidal.sources.how": "Come",
  "config.methodo.tidal.access.keyless": "senza chiave",
  "config.methodo.tidal.access.free_account": "account gratuito",
  "config.methodo.tidal.access.api_key": "chiave API gratuita",
  "config.methodo.tidal.access.sftp_account": "SFTP con account",
  "config.methodo.tidal.access.on_request": "su richiesta",
  "config.methodo.tidal.access.paid": "a pagamento",
  "config.methodo.tidal.access.none": "nessun accesso aperto",
  "config.methodo.tidal.licenceClass.open": "aperta",
  "config.methodo.tidal.licenceClass.non_commercial": "non commerciale",
  "config.methodo.tidal.licenceClass.paid": "a pagamento",
  "config.methodo.tidal.licenceClass.other": "altra, da chiarire",
  "config.methodo.tidal.automation.auto": "sì",
  "config.methodo.tidal.automation.auto_secret": "sì, con un segreto",
  "config.methodo.tidal.automation.manual": "manuale",
  "config.methodo.tidal.automation.none": "no",
  "config.methodo.tidal.cadence.live": "a ogni richiesta",
  "config.methodo.tidal.cadence.daily": "ogni giorno",
  "config.methodo.tidal.cadence.weekly": "ogni settimana",
  "config.methodo.tidal.cadence.monthly": "ogni mese",
  "config.methodo.tidal.cadence.yearly": "ogni anno",
  "config.methodo.tidal.cadence.decade": "ogni 10 anni",
  "config.methodo.tidal.cadence.frozen": "congelata",
  "config.methodo.tidal.cadence.none": "non prevista",
  "config.methodo.tidal.freshness.live": "in diretta",
  "config.methodo.tidal.freshness.fresh": "aggiornati",
  "config.methodo.tidal.freshness.late": "in ritardo",
  "config.methodo.tidal.freshness.frozen": "edizione congelata",
  "config.methodo.tidal.freshness.undated": "senza data",
  "config.methodo.tidal.freshness.unserved": "non serviti",
  "config.methodo.tidal.freshness.note": "«Aggiornati»: la nostra copia è stata ricostruita entro il termine previsto dalla sua frequenza di aggiornamento (data della fine del periodo analizzato). «In ritardo»: l'ultimo aggiornamento previsto non è avvenuto. Un atlante di marea in ritardo resta servito: le sue costanti armoniche restano valide per anni, il segnale serve a individuare una catena di aggiornamento ferma.",
