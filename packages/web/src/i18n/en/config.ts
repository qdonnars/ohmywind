...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Covered, tide not significant: a tidal model covers these waters and finds under 0.2 kt there (0.5 kt in the Baltic); the current shown comes from the global model, which also carries the wind-driven flow",
