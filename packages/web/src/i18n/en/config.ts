...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.hint": "Click on the sea: the card names the source the app uses at that point, as the server picks it.",
  "config.methodo.tidal.legend.current": "1. Where the current is",
  "config.methodo.tidal.layer.mask05": "Over 0.5 kt (computed, North-East Atlantic)",
  "config.methodo.tidal.layer.mask15": "Over 1.5 kt (computed, North-East Atlantic)",
  "config.methodo.tidal.layer.passes": "Known passes and races, sized by current",
  "config.methodo.tidal.legend.coverage": "2. What the app uses",
  "config.methodo.tidal.layer.shom": "SHOM points (fine, within 500 m of a point)",
  "config.methodo.tidal.layer.fine": "Fine: 500 m or better, resolves a pass",
  "config.methodo.tidal.layer.medium": "Medium: up to 1 km, resolves an estuary",
  "config.methodo.tidal.layer.coarse": "Coarse: 2 km, only says \"there is tide here\"",
  "config.methodo.tidal.layer.spike": "In preparation (BSH, not served yet)",
  "config.methodo.tidal.legend.gaps": "3. What is missing in the target area",
  "config.methodo.tidal.layer.objective": "Target area (Europe)",
  "config.methodo.tidal.layer.gapMask": "Over 1.5 kt without a fine or medium source",
  "config.methodo.tidal.layer.gapPasses": "Known pass without a fine or medium source",
  "config.methodo.tidal.layer.sources": "Candidate sources (registry, licence read and dated)",
  "config.methodo.tidal.note": "Elsewhere the app uses the global Open-Meteo SMOC model at 8 km. The \"where the current is\" layer is computed from the 2 km ATLNE atlas and cannot see a pass narrower than its cell: the known passes fill in.",
  "config.methodo.tidal.popup.title": "Here, the app uses",
  "config.methodo.tidal.popup.loading": "Asking the server…",
  "config.methodo.tidal.popup.error": "Server unreachable: no answer for this point.",
  ...
  "config.methodo.tidal.popup.shom": "SHOM Atlas C2D, point sampled {distance} m away",
  "config.methodo.tidal.popup.precision": "Precision",
  "config.methodo.tidal.precision.fine": "fine (500 m or better)",
  "config.methodo.tidal.precision.medium": "medium (up to 1 km)",
  "config.methodo.tidal.precision.coarse": "coarse (2 km)",
  "config.methodo.tidal.precision.global": "global (8 km)",
  "config.methodo.tidal.popup.current": "Maximum tidal current here",
  "config.methodo.tidal.current.over15": "over 1.5 kt",
  "config.methodo.tidal.current.over05": "between 0.5 and 1.5 kt",
  "config.methodo.tidal.current.under05": "under 0.5 kt",
  "config.methodo.tidal.current.unknown": "outside the computation",
  ...
  "config.methodo.tidal.popup.none": "none identified",
  "config.methodo.tidal.popup.objective": "Target area",
  "config.methodo.tidal.popup.yes": "yes",
  "config.methodo.tidal.popup.no": "no",
  "config.methodo.tidal.pass.published": "Published spring current",
  "config.methodo.tidal.pass.confidence": "Reliability of the figure",
  "config.methodo.tidal.pass.coverage": "Current coverage",
  "config.methodo.tidal.pass.coverageNone": "none, global model only",
  "config.methodo.tidal.pass.reference": "Reference",
  "config.methodo.tidal.source.status.ok": "licence compatible",
  "config.methodo.tidal.source.status.clarify": "to be clarified",
  "config.methodo.tidal.source.status.blocked": "blocked",
  "config.methodo.tidal.source.status.no_currents": "no currents",
  "config.methodo.tidal.source.status.current": "in the cascade",
  "config.methodo.tidal.source.resolution": "Resolution",
