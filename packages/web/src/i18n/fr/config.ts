...
export const config = {
  ...
  "config.methodo.tidal.legend.negligible": "Couvert, marée non significative : un modèle de marée couvre ces eaux et n'y trouve pas 0,2 kt (0,5 kt en Baltique) ; le courant affiché vient du modèle global, qui porte aussi les courants de vent",
