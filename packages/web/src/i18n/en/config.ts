...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.fullscreen.ramp": "0 to 5 kt and above",
  "config.methodo.tidal.legend.title": "Tidal current computed from the atlases (0.5 kt and above)",
  "config.methodo.tidal.legend.covered": "Covered: maximum tidal current, from the palest green at 0 kt to the darkest at 5 kt and above",
  ...
  "config.methodo.tidal.legend.negligible": "Same pale green: covered, tide not significant (a tidal model finds under 0.2 kt there, 0.5 kt in the Baltic); the current shown there comes from the global model, which also carries the wind-driven flow",
  ...
  "config.methodo.tidal.status.negligible": "covered, tide not significant: the tidal model finds under 0.2 kt here (0.5 kt in the Baltic); the current shown comes from the global model",
  ...
  "config.methodo.tidal.sources.grid": "Grid",
  ...
  "config.methodo.tidal.sources.accessKind": "Access and licence",
  "config.methodo.tidal.sources.automation": "Automatable",
  "config.methodo.tidal.sources.cadence": "Updates",
  "config.methodo.tidal.sources.freshness": "Data status",
  "config.methodo.tidal.sources.how": "How",
  "config.methodo.tidal.access.keyless": "no key",
  "config.methodo.tidal.access.free_account": "free account",
  "config.methodo.tidal.access.api_key": "free API key",
  "config.methodo.tidal.access.sftp_account": "SFTP with account",
  "config.methodo.tidal.access.on_request": "on request",
  "config.methodo.tidal.access.paid": "paid",
  "config.methodo.tidal.access.none": "no open access",
  "config.methodo.tidal.licenceClass.open": "open",
  "config.methodo.tidal.licenceClass.non_commercial": "non-commercial",
  "config.methodo.tidal.licenceClass.paid": "paid",
  "config.methodo.tidal.licenceClass.other": "other, unclear",
  "config.methodo.tidal.automation.auto": "yes",
  "config.methodo.tidal.automation.auto_secret": "yes, with a secret",
  "config.methodo.tidal.automation.manual": "manual",
  "config.methodo.tidal.automation.none": "no",
  "config.methodo.tidal.cadence.live": "on every request",
  "config.methodo.tidal.cadence.daily": "daily",
  "config.methodo.tidal.cadence.weekly": "weekly",
  "config.methodo.tidal.cadence.monthly": "monthly",
  "config.methodo.tidal.cadence.yearly": "yearly",
  "config.methodo.tidal.cadence.decade": "every 10 years",
  "config.methodo.tidal.cadence.frozen": "frozen",
  "config.methodo.tidal.cadence.none": "not planned",
  "config.methodo.tidal.freshness.live": "live",
  "config.methodo.tidal.freshness.fresh": "up to date",
  "config.methodo.tidal.freshness.late": "late",
  "config.methodo.tidal.freshness.frozen": "frozen edition",
  "config.methodo.tidal.freshness.undated": "undated",
  "config.methodo.tidal.freshness.unserved": "not served",
  "config.methodo.tidal.freshness.note": "\"Up to date\": our copy was rebuilt within the delay its update frequency allows (date of the end of the analysed period). \"Late\": the last planned update did not happen. A late tidal atlas is still served: its harmonic constants stay valid for years, the flag is there to spot an update pipeline that stopped.",
