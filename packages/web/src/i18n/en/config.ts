...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.target": "Over 1.5 kt not covered, an open source is identified",
  "config.methodo.tidal.legend.blocked": "Over 1.5 kt not covered, data exists but is closed or unclear",
  "config.methodo.tidal.legend.unknown": "Over 1.5 kt not covered, no known source",
  ...
  "config.methodo.tidal.note": "Elsewhere the app uses the global Open-Meteo SMOC model at 8 km. The \"where there is current\" computation comes from the finest atlas available at each place (MARC 250 to 700 m, BSH 90 to 926 m, Copernicus 1.5 to 4 km, ATLNE 2 km, FES2014 7 km): a pass narrower than the grid does not show there, the known passes complete it.",
  ...
  "config.methodo.tidal.popup.passedOver": "Also available here, passed over",
  "config.methodo.tidal.reason.noShomPoint": "no surveyed point within 500 m",
  "config.methodo.tidal.reason.afterShom": "SHOM first",
  "config.methodo.tidal.reason.lowerRank": "lower rank",
  "config.methodo.tidal.reason.coarser": "coarser grid",
  "config.methodo.tidal.reason.tie": "same rank, second",
  ...
  "config.methodo.tidal.precision.coarse": "coarse (1 to 3 km)",
  "config.methodo.tidal.precision.global": "wide (over 3 km, or the global model)",
  "config.methodo.tidal.popup.status": "Zone status",
  "config.methodo.tidal.status.covered": "covered",
  "config.methodo.tidal.status.coveredValue": "covered, maximum tidal current {kt} kt ({atlas})",
  "config.methodo.tidal.status.calmValue": "covered, weak tide: {kt} kt at most ({atlas})",
  "config.methodo.tidal.status.calm": "covered, weak tidal current",
  "config.methodo.tidal.status.target": "not covered, an open source is identified",
  ...
  "config.methodo.tidal.popup.fallback": "Worldwide fallback",
  "config.methodo.tidal.popup.fallbackNote": "does not count as coverage",
  ...
  "config.methodo.tidal.pass.published": "Published spring-tide current",
  ...
  "config.methodo.tidal.source.status.ok": "compatible licence",
  "config.methodo.tidal.source.status.clarify": "to clarify",
