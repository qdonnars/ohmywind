...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Abgedeckt, Gezeiten nicht maßgeblich: Ein Gezeitenmodell deckt diese Gewässer ab und findet dort unter 0,2 kn (0,5 kn in der Ostsee); die angezeigte Strömung stammt aus dem globalen Modell, das auch die windgetriebene Strömung enthält",
