...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Vernachlässigbare Gezeiten, unter 0,5 kn (gemessen mit Copernicus Ostsee, nicht bereitgestellt): Die App nutzt dort die globale Strömung, die auch die windgetriebene Strömung enthält",
  ...
  "config.methodo.tidal.status.negligible": "vernachlässigbare Gezeiten (unter 0,5 kn laut Copernicus Ostsee): Die angezeigte Strömung stammt aus dem globalen Modell",
