...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.popup.passedOver": "También disponibles aquí, descartadas (rango, luego resolución)",
  "config.methodo.tidal.popup.ignoredAtlas": "{label}, malla {size}, rango {rank}",
  "config.methodo.tidal.popup.shomZone": "SHOM Atlas C2D, zona {zone} (usado a menos de 500 m de un punto medido)",
