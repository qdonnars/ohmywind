...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Coperto, marea non significativa: un modello di marea copre queste acque e vi trova meno di 0,2 kn (0,5 kn nel Baltico); la corrente mostrata viene dal modello globale, che porta anche le correnti da vento",
