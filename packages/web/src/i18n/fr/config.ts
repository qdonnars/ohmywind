...
export const config = {
  ...
  "config.methodo.tidal.legend.negligible": "Marée négligeable, moins de 0,5 kt (mesurée par Copernicus Baltique, non servie) : l'application y utilise le courant global, qui porte aussi les courants de vent",
  ...
  "config.methodo.tidal.status.negligible": "marée négligeable (moins de 0,5 kt d'après Copernicus Baltique) : le courant affiché vient du modèle global",
