...
export const config = {
  ...
  "config.methodo.tidal.fullscreen.ramp": "0 à 5 kt et plus",
  "config.methodo.tidal.legend.title": "Courant de marée calculé depuis les atlas (0,5 kt et plus)",
  "config.methodo.tidal.legend.covered": "Couvert : courant de marée maximal, du vert le plus pâle à 0 kt au plus foncé à 5 kt et plus",
  "config.methodo.tidal.legend.calm": "Couvert, courant de marée faible (moins de 0,5 kt)",
  "config.methodo.tidal.legend.target": "Plus de 1,5 kt non couvert, source ouverte identifiée",
  "config.methodo.tidal.legend.blocked": "Plus de 1,5 kt non couvert, données existantes mais fermées ou à clarifier",
  "config.methodo.tidal.legend.unknown": "Plus de 1,5 kt non couvert, aucune source connue",
  ...
  "config.methodo.tidal.legend.negligible": "Même vert pâle : couvert, marée non significative (un modèle de marée n'y trouve pas 0,2 kt, 0,5 kt en Baltique) ; le courant affiché y vient du modèle global, qui porte aussi les courants de vent",
  "config.methodo.tidal.legend.objective": "Zone objectif",
  "config.methodo.tidal.note": "Ailleurs, l'application utilise le modèle global Open-Meteo SMOC à 8 km. Le calcul « où il y a du courant » vient de l'atlas le plus fin disponible à chaque endroit (MARC 250 à 700 m, BSH 90 à 926 m, Copernicus 1,5 à 4 km, ATLNE 2 km, FES2014 7 km) : une passe plus étroite que la maille n'y apparaît pas, les passes connues complètent.",
  "config.methodo.tidal.popup.title": "Ici, l'application utilise",
  "config.methodo.tidal.popup.loading": "Interrogation du serveur…",
  "config.methodo.tidal.popup.error": "Serveur injoignable : réponse indisponible pour ce point.",
  "config.methodo.tidal.popup.source": "Source",
  "config.methodo.tidal.popup.passedOver": "Aussi disponibles ici, écartées",
  "config.methodo.tidal.reason.noShomPoint": "aucun point relevé à 500 m",
  "config.methodo.tidal.reason.afterShom": "SHOM d'abord",
  "config.methodo.tidal.reason.lowerRank": "rang inférieur",
  "config.methodo.tidal.reason.coarser": "maille plus grossière",
  "config.methodo.tidal.reason.tie": "même rang, second",
  ...
  "config.methodo.tidal.precision.fine": "fine (500 m ou mieux)",
  "config.methodo.tidal.precision.medium": "moyenne (jusqu'à 1 km)",
  "config.methodo.tidal.precision.coarse": "grossière (1 à 3 km)",
  "config.methodo.tidal.precision.global": "large (plus de 3 km, ou modèle global)",
  "config.methodo.tidal.popup.status": "Statut de la zone",
  "config.methodo.tidal.status.covered": "couverte",
  "config.methodo.tidal.status.coveredValue": "couverte, courant de marée maximal {kt} kt ({atlas})",
  "config.methodo.tidal.status.calmValue": "couverte, marée faible : {kt} kt au maximum ({atlas})",
  "config.methodo.tidal.status.negligible": "couvert, marée non significative : le modèle de marée n'y trouve pas 0,2 kt (0,5 kt en Baltique) ; le courant affiché vient du modèle global",
  "config.methodo.tidal.status.calm": "couverte, courant de marée faible",
  "config.methodo.tidal.status.target": "non couverte, source ouverte identifiée",
  ...
  "config.methodo.tidal.popup.fallback": "Repli mondial",
  "config.methodo.tidal.popup.fallbackNote": "ne compte pas comme couverture",
  ...
  "config.methodo.tidal.popup.no": "non",
  "config.methodo.tidal.pass.published": "Courant de vive-eau publié",
  "config.methodo.tidal.pass.confidence": "Fiabilité du chiffre",
  "config.methodo.tidal.pass.coverage": "Couverture actuelle",
  "config.methodo.tidal.pass.coverageNone": "aucune, modèle global seulement",
  "config.methodo.tidal.pass.reference": "Référence",
  "config.methodo.tidal.source.status.ok": "licence compatible",
  "config.methodo.tidal.source.status.clarify": "à clarifier",
  "config.methodo.tidal.source.status.blocked": "bloquée",
  "config.methodo.tidal.source.status.no_currents": "sans courants",
  "config.methodo.tidal.source.status.current": "dans la cascade",
  "config.methodo.tidal.source.resolution": "Résolution",
  ...
  "config.methodo.tidal.sources.grid": "Maille",
  ...
  "config.methodo.tidal.sources.accessKind": "Accès et licence",
  "config.methodo.tidal.sources.automation": "Automatisable",
  "config.methodo.tidal.sources.cadence": "Mise à jour",
  "config.methodo.tidal.sources.freshness": "État des données",
  "config.methodo.tidal.sources.how": "Comment",
  "config.methodo.tidal.access.keyless": "sans clé",
  "config.methodo.tidal.access.free_account": "compte gratuit",
  "config.methodo.tidal.access.api_key": "clé API gratuite",
  "config.methodo.tidal.access.sftp_account": "SFTP avec compte",
  "config.methodo.tidal.access.on_request": "sur demande",
  "config.methodo.tidal.access.paid": "payant",
  "config.methodo.tidal.access.none": "aucun accès ouvert",
  "config.methodo.tidal.licenceClass.open": "ouverte",
  "config.methodo.tidal.licenceClass.non_commercial": "non commerciale",
  "config.methodo.tidal.licenceClass.paid": "payante",
  "config.methodo.tidal.licenceClass.other": "autre, à clarifier",
  "config.methodo.tidal.automation.auto": "oui",
  "config.methodo.tidal.automation.auto_secret": "oui, avec un secret",
  "config.methodo.tidal.automation.manual": "manuel",
  "config.methodo.tidal.automation.none": "non",
  "config.methodo.tidal.cadence.live": "à chaque requête",
  "config.methodo.tidal.cadence.daily": "chaque jour",
  "config.methodo.tidal.cadence.weekly": "chaque semaine",
  "config.methodo.tidal.cadence.monthly": "chaque mois",
  "config.methodo.tidal.cadence.yearly": "chaque année",
  "config.methodo.tidal.cadence.decade": "tous les 10 ans",
  "config.methodo.tidal.cadence.frozen": "figée",
  "config.methodo.tidal.cadence.none": "non prévue",
  "config.methodo.tidal.freshness.live": "en direct",
  "config.methodo.tidal.freshness.fresh": "à jour",
  "config.methodo.tidal.freshness.late": "en retard",
  "config.methodo.tidal.freshness.frozen": "édition figée",
  "config.methodo.tidal.freshness.undated": "non datée",
  "config.methodo.tidal.freshness.unserved": "non servie",
  "config.methodo.tidal.freshness.note": "« À jour » : notre copie a été reconstruite dans le délai prévu par sa fréquence de mise à jour (date de la fin de la période analysée). « En retard » : la dernière mise à jour prévue n'a pas eu lieu. Un atlas de marée en retard reste servi : ses constantes harmoniques restent valables des années, le signal sert à repérer une chaîne de mise à jour arrêtée.",
