...
- Étapes (gestes au doigt, depuis le 2026-09-12): sur une route tracée, (a) poser le doigt sur l'eau une seconde sans bouger puis lever; (b) tap bref sur l'eau; (c) tap sur un waypoint du milieu; (d) appui maintenu ~350 ms sur un waypoint jusqu'au léger grossissement, puis glisser; (e) poser le doigt sur un waypoint et bouger tout de suite; (f) tap à environ 10 px à côté d'un segment; (g) calculer, déplier un tronçon, taper sur le tronçon surligné; (h) saisir la poignée du tiroir en visant un peu trop haut.
- Attendu: (a) aucun point ajouté; (b) un point ajouté; (c) le waypoint disparaît et « Point N retiré · Annuler » s'affiche en haut de carte 5 s, Annuler le remet à sa place; (d) le waypoint suit le doigt avec le pointillé, la carte ne bouge pas, la route passe en « à recalculer » au lâcher; (e) la carte se déplace, le waypoint reste; (f) un point est inséré sur le trait, pas à côté, dans le bon tronçon, et jamais ajouté en fin de route; (g) idem, inséré dans ce tronçon; (h) le tiroir se redimensionne, aucun point n'apparaît. À la souris rien ne change: × au survol, glissé immédiat, clic sur le trait insère. Le double clic ou double tap sur l'eau n'ajoute qu'un point et ne zoome pas.
