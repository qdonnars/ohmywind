...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.legend.negligible": "Marea trascurabile, sotto 0,5 kn (misurata da Copernicus Baltico, non servita): l'app vi usa la corrente globale, che porta anche le correnti da vento",
  ...
  "config.methodo.tidal.status.negligible": "marea trascurabile (sotto 0,5 kn secondo Copernicus Baltico): la corrente mostrata viene dal modello globale",
