...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.popup.passedOver": "Disponibili anche qui, scartate (rango, poi risoluzione)",
  "config.methodo.tidal.popup.ignoredAtlas": "{label}, maglia {size}, rango {rank}",
  "config.methodo.tidal.popup.shomZone": "SHOM Atlas C2D, zona {zone} (usato entro 500 m da un punto rilevato)",
