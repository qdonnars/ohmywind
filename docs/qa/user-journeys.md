...
- Précondition: un spot existe (J2).
- Étapes: entrer en mode planification (menu en haut à gauche, le bouton rond avec trois traits, puis « Planifier »). Tracer une route d'au moins 2 segments par appuis sur la carte. Observer le bandeau/tiroir de plan (récapitulatif distance, durée, complexité). Taper dessus, puis essayer un swipe vertical dessus.
...
- Étapes: ouvrir le menu (bouton rond en haut à gauche : sur la carte au-dessus de 1024 px, dans le header à la place du logo en dessous). Observer les trois entrées (Explorer, Planifier, Comparer mes spots) et la pastille sur le bouton qui indique la page courante. Choisir « Comparer mes spots ». Taper un spot sur la carte, puis une heure dans la frise, puis la pastille « Vagues » si elle est proposée. Toucher la flèche « ↗ » d'une ligne. Bouton retour Android avec le menu ouvert.
- Attendu: une seule occurrence du menu dans la page (jamais les deux). La carte cadre tous les spots enregistrés au-dessus du tableau. Une ligne par spot, mêmes cellules colorées que la table du vent, le modèle lu sous le nom du spot. Taper un marqueur surligne sa ligne et la fait défiler à la vue; taper une heure la surligne sur toutes les lignes et dessine la flèche du spot surligné sur la carte. « Vagues » n'apparaît que si un spot a de la houle. « ↗ » ouvre Explorer sur ce spot. Sans aucun spot enregistré : carte nue et carte d'invitation avec un lien vers Explorer. Retour Android : ferme le menu sans quitter l'app.
