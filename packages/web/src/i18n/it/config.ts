...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.status.coveredBand": "coperta, corrente di marea massima {band}",
  "config.methodo.tidal.band.between": "da {a} a {b} kn",
  "config.methodo.tidal.band.over": "{kt} kn e oltre",
