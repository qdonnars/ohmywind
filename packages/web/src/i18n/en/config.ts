...
export const config: Record<keyof typeof frConfig, string> = {
  ...
  "config.methodo.tidal.popup.passedOver": "Also available here, passed over (rank, then resolution)",
  "config.methodo.tidal.popup.ignoredAtlas": "{label}, {size} grid, rank {rank}",
  "config.methodo.tidal.popup.shomZone": "SHOM Atlas C2D, zone {zone} (used within 500 m of a surveyed point)",
